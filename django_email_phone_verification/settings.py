"""
Django settings for django_email_phone_verification project.
...
SECRET_KEY = 'sbpc*t-0-avzh_(7mlel3tle_iv&%s1_q$aisfr4!$pw_xiu6%'
...
ROOT_URLCONF = 'django_email_phone_verification.urls'
